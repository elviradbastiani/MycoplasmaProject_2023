...
###############################################################################################################################
###############################################################################################################################
#S1 Script: Separating the window days of movement ecology data for griffon vultures prior to Mycoplasma spp. sampling in 2021.
###############################################################################################################################
###############################################################################################################################
...
roostPolygons <- sf::st_read("data/roosts_to_roosting_situation.kml", quiet = TRUE) %>%
